...
class ConflictsControllerTest < ActionController::TestCase
  ...
  test "should create conflict" do
    assert_difference('Conflict.count') do
      post :create, conflict: { date: @conflict.date, end: @conflict.end, reason: @conflict.reason, start: @conflict.start }
    end
  ...
  test "should update conflict" do
    put :update, id: @conflict, conflict: { date: @conflict.date, end: @conflict.end, reason: @conflict.reason, start: @conflict.start }
    assert_redirected_to conflict_path(assigns(:conflict))
  end
